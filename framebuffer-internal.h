...
#     define PI_REV1_RGB_PINOUT_
  ...
  union IoBits {
    struct {
      ...
      // compute module change
      unsigned int unused_28_29   : 2;  // 28..29

      unsigned int p3_r1          : 1;  // 30
      unsigned int p3_r2          : 1;  // 31
      unsigned int p3_g1          : 1;  // 32
      unsigned int p3_g2          : 1;  // 33
      unsigned int p3_b1          : 1;  // 34
      unsigned int p3_b2          : 1;  // 35

      unsigned int unused_36_37   : 2;  // 36..37

      unsigned int p4_r1          : 1;  // 38
      unsigned int p4_r2          : 1;  // 39
      unsigned int p4_g1          : 1;  // 40
      unsigned int p4_g2          : 1;  // 41
      unsigned int p4_b1          : 1;  // 42
