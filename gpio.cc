...
/*static*/ const uint64_t GPIO::kValidBits	// change
= ((1 <<  0) | (1 <<  1) | // RPi 1 - Revision 1 accessible
   ...
   (1 << 19) | (1 << 20) | (1 << 21) | (1 << 26) | (1 << 30) | (1 << 31) |
   // Compute Module
   ((uint64_t)1 << 32) | ((uint64_t)1 << 33) | ((uint64_t)1 << 34) | ((uint64_t)1 << 35) |	// change
   ((uint64_t)1 << 38) | ((uint64_t)1 << 39) | ((uint64_t)1 << 40) | ((uint64_t)1 << 41) | ((uint64_t)1 << 42) | ((uint64_t)1 << 43)
);
